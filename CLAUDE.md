...
- **CRITICAL (failures 2026-06-19, 2026-07-03):** a nudge can arrive MID-TASK as a harness *"the user sent a new message while you were working"* injection and is easy to miss. In the live `orch` session, **treat EVERY operator message as Telegram-bound: ALWAYS `tg_send` your reply** — if you're the `orch` session, the operator is on his phone.
