...
# ── TOOLING REACHABILITY (op#13650, 2026-08-16). This body runs with cwd=$CAI_DIR, which
...
if [ ! -e "$CAI_DIR/scripts" ]; then
  ...
  echo "⚠ $CAI_DIR/scripts exists but has no self_recycle.sh — use an ABSOLUTE path" >&2
fi
