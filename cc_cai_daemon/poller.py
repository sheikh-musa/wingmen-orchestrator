...
def fetch_unread_for_cai(dsn: str) -> list[dict]:
    ...
    Excludes already-forwarded-to-telegram rows so we don't double-process
    something the existing orch agent_messages_poll already routed.
