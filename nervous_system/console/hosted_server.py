...
class _Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):  # noqa: N802
        ...
        try:
            ...
            pass
        # The public console is strictly read-only: reset / backlog mutations are
        # refused here (they exist only on the Mini console's writable env).
        if path in ("/api/reset", "/api/backlog"):
